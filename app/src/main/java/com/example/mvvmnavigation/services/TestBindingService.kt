...
class TestBindingService : Service() {
    ...
    /** Есть автоматическое связывание, а есть вручную.
     * При ручном есть преиущество: когда мы переворачиваем экран, срабатывает onStop, где при автоматичнском сервис бы отвязывался.
     * Но при таком связывании можно решать подобные проблемы
     */
